            ...
            <Carousel.Item>
              <div className="row">
                <div className="col-xxs-12 col-xs-6 col-sm-6 col-md-3 ulockd-pad395">
                  <div
                    className="about-box2 text-center wow fadeInUp"
                  ...
                  >
                    ...
                    <div className="ab-details">
                      <h3>Entertainment</h3>
                      <p>
                        Event is the most efficient & direct tool for any
                        communication. Entertainment in an event helps to leave
                        a better.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-xxs-12 col-xs-6 col-sm-6 col-md-3 ulockd-pad395">
                  ...
                  >
                    ...
                    <div className="ab-details">
                      <h3>Events</h3>
                      <p>
                        We know how important any event that you do is to you
                        whether in the corporate field or personally.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-xxs-12 col-xs-6 col-sm-6 col-md-3 ulockd-pad395">
                  ...
                  >
                    ...
                    <div className="ab-details">
                      ...
                      <p>
                        The Wedding is a once-in-lifetime event and everyone
                        wants a ravishing venue for that moment.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-xxs-12 col-xs-6 col-sm-6 col-md-3 ulockd-pad395">
                  ...
                  >
                    ...
                    <div className="ab-details">
                      <h3>Hospitality</h3>
                      <p>
                        Travel and Hotel arrangement is one of the major
                        tensions while hosting any event. Therefore, to relieve
                        you so that.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-xxs-12 col-xs-6 col-sm-6 col-md-3 ulockd-pad395">
                  ...
                  >
                    ...
                    <div className="ab-details">
                      ...
                      <p>
                        The Events Maestro & Entertainments is a leading event
                        management company in India, catering to the needs..
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-xxs-12 col-xs-6 col-sm-6 col-md-3 ulockd-pad395">
                  ...
                  >
                    ...
                    <div className="ab-details">
                      ...
                      <p>
                        If you are planning to hold an event for your company or
                        in your city with Bollywood Singers, then Event Mestro
                        ..
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-xxs-12 col-xs-6 col-sm-6 col-md-3 ulockd-pad395">
                  ...
                  >
                    ...
                    <div className="ab-details">
                      ...
                      <p>
                        Events Maestro & Entertainments is a well-reputed
                        company which specializes in event management.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-xxs-12 col-xs-6 col-sm-6 col-md-3 ulockd-pad395">
                  ...
                  >
                    ...
                    <div className="ab-details">
                      <h3>Anchors</h3>
                      <p>
                        Event Delight & Entertainments is having a dynamic and
                        vibrant group of young professionals as Anchors.
                      </p>
                    </div>
                  </div>
                </div>
